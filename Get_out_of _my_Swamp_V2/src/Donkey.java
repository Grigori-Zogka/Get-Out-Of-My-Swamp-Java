...
public class Donkey extends GameObject {
	...
	public Donkey(float xPosition, float yPosition, Handler handler, ObjectId id) {
	...
	public void collision() {
		...
		for(int i=0; i < handler.object.size(); i++) {
			...
			if(getBounds().intersects(tempObject.getBounds())){
				...
				System.out.println("Donkey is dead!");
				JOptionPane.showMessageDialog(null, "HEK killed the Donkey", "Fight",JOptionPane.INFORMATION_MESSAGE);
